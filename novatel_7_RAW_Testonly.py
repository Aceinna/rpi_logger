...
"""
Program to log solution in binary from Novatel CPT7
...
def configNovatel(ser):
    ...
    setupcommands7  = ['unlogall\r',\
                ...
                'setinstranslation ant1 1.9355 -0.2455 -1.03 0.10 0.10 0.10\r',\
                'setinstranslation ant2 1.9355  0.6115 -1.03 0.10 0.10 0.10\r',\
                'setinsrotation rbv 180 0 90\r',\
                'setinstranslation USER 1.9355 -0.2455 -1.03 0.10 0.10 0.10 IMUBODY\r',\
